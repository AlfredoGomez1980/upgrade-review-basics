...
function volumeAverage(users) {
  ...
  console.log(volumeAverage(users));
...
console.log(findArrayIndex(myArray, 'Caracol'));
console.log(findArrayIndex(myArray, 'Mosquito'));
console.log(findArrayIndex(myArray, 'Salamandra'));
...
function rollDice(caras) {
    let numeroCaras = caras;
    let numeroAleatorio = parseInt(Math.random() * (numeroCaras) + 1);
...
myArray = ['Mesirve', 'Cristiano Romualdo', 'Fernando Muralla', 'Ronalguiño'];

function swap(array, firstElement, secondElement){
    const auxElement = array[firstElement];
    array[firstElement] = array[secondElement];
    array[secondElement] = auxElement;
